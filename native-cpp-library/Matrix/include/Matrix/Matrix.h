#ifndef C7473C75_E432_4743_8D0D_9159350CF3EE
#define C7473C75_E432_4743_8D0D_9159350CF3EE
...
namespace MatComp
{
    ...
    template <typename Ty>
    Matrix<Ty> neg(const Matrix<Ty> &m)
    {
        return Matrix(m).neg();
    }
    ...
    template <typename Ty>
    Matrix<Ty> abs(const Matrix<Ty> &m)
    {
        return Matrix(m).abs();
    }
    ...
    /// Functional version of neg.
    template <typename Ty>
    Matrix<Ty> sqrt(const Matrix<Ty> &m)
    {
    ...
    /// Functional version of abs.
    template <typename Ty>
    Matrix<Ty> log(const Matrix<Ty> &m)
    {
        return Matrix(m).log();
    }
...
#endif /* C7473C75_E432_4743_8D0D_9159350CF3EE */
